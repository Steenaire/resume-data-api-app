...
Education.create!([
  {degree: "Master", university_name: "School of hard knocks", details: "Got some book learning", start_date: "1985-01-01", end_date: "2000-01-01", student_id: 1}
])
Experience.create!([
  {job_title: "Captain", company_name: "Good Ship Tarman", details: "Captained the liveship Tarman on the Rain Wild River", start_date: "2001-01-01", end_date: "2008-01-01", student_id: 1}
])
Education.create!([
...
Experience.create!([
  {job_title: "Software engineer", company_name: "Happy employees", details: "Have been involved in development of many of the modules specially payment", start_date: "2008-09-03", end_date: "2013-01-01", student_id: 2}
])
Skill.create!([
